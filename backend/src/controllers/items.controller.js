...
const createItem = asyncHandler(async (req, res) => {
    const { itemName, description, category, location, images, lostDate } = req.body;
...
export { createItem, getAllLostItems, getLostItem, updateItemStatus , getAllFoundItems, updateItemDetails, deleteItem, searchItems };
